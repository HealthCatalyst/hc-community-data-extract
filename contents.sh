#!/bin/bash
# Also returns reports of counts of tags and categories
# JQ required
...
curl GET -i -v -u "USERNAME:PASSWORD" -H "Content-Type: application/json" "https://community.healthcatalyst.com/api/core/v3/contents?sort=latestActivityDesc&filter=type(discussion)&fields=-content.text&count=100&startIndex="$set"&directive=silent" > bin/contents/discussion_"$set".json
...
curl GET -i -v -u "USERNAME:PASSWORD" -H "Content-Type: application/json" "https://community.healthcatalyst.com/api/core/v3/contents?sort=latestActivityDesc&filter=type(document)&fields=-content.text&count=100&startIndex="$set"&directive=silent" > bin/contents/doc_"$set".json
...
curl GET -i -v -u "USERNAME:PASSWORD" -H "Content-Type: application/json" "https://community.healthcatalyst.com/api/core/v3/contents?sort=latestActivityDesc&filter=type(file)&fields=-content.text&count=100&startIndex="$set"&directive=silent" > bin/contents/file_"$set".json
...
curl GET -i -v -u "USERNAME:PASSWORD" -H "Content-Type: application/json" "https://community.healthcatalyst.com/api/core/v3/contents?sort=latestActivityDesc&filter=type(idea)&fields=-content.text&count=100&startIndex="$set"&directive=silent" > bin/contents/idea_"$set".json
...
curl GET -i -v -u "USERNAME:PASSWORD" -H "Content-Type: application/json" "https://community.healthcatalyst.com/api/core/v3/contents?sort=latestActivityDesc&filter=type(poll)&fields=-content.text&count=100&startIndex="$set"&directive=silent" > bin/contents/poll_"$set".json
...
curl GET -i -v -u "USERNAME:PASSWORD" -H "Content-Type: application/json" "https://community.healthcatalyst.com/api/core/v3/contents?sort=latestActivityDesc&filter=type(post)&fields=-content.text&count=100&startIndex="$set"&directive=silent" > bin/contents/post_"$set".json
...
curl GET -i -v -u "USERNAME:PASSWORD" -H "Content-Type: application/json" "https://community.healthcatalyst.com/api/core/v3/contents?sort=latestActivityDesc&filter=type(video)&fields=-content.text,-videoMetadata&startIndex="$set"&count=100&directive=silent" > bin/contents/video_"$set".json
...
jq -s . <4.json >contents.json

# EXPORT COUNT OF TAGS
jq '.[] | .tags[]' <contents.json >a.json
jq . -s <a.json >tags.json

# EXPORT COUNT OF CATEGORIES
